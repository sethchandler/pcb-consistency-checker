...
import { runMultiPassAnalysis } from './multiPassAnalysisNew';
...
export const runConsistencyAnalysis = async (): Promise<void> => {
  ...
  // Check API key requirement based on provider
  ...
  try {
    ...
    // Step 4: Run multi-pass or single-pass analysis with new provider system
